...
function gerarLista(){
    console.log(criarListaMultiploCinco(quantidade))
}

// console.log(criarListaMultiploCinco(10))
// console.log(criarListaNumerosPares(10))
// console.log(criarListaNumerosImpares(10))
console.log(criarListaNumerosAoQuadrado(10))